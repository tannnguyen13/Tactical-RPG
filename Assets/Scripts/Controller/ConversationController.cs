...
public class ConversationController : MonoBehaviour
{
    ...
    Canvas canvas; //having a reference to canvas allows you to turn it off to enhance performance
    IEnumerator conversation; //having a reference to an IEnumerator allows you to step through all the speakers and their messages in a conversation
    Tweener transition; //reference to a Tweener so that user cannot advance the conversation's position while transition is happening
