...
public class TestItems : MonoBehaviour
{
    ...
    void CreateItems()
    {
        ...
        inventory.Add(CreateEquippableItem("Sword", StatTypes.STR, 10, EquipSlots.Primary));
        inventory.Add(CreateEquippableItem("Broad Sword", StatTypes.STR, 15, (EquipSlots.Primary | EquipSlots.Secondary)));
